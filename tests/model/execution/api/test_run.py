...
class RunSuiteSelectionResourceTest(case.api.ApiTestCase):
            ...
            exp_objects.append(
                {
                    ...
                    u"resource_uri": unicode(
                        self.get_detail_url("runsuiteselection",s.id)),
    ...
    def test_two_selected(self):
        ...
        res = self.get_list(params={"for_run": run.id})
        self.assertEqual(res.status_int, 200)
        ...
        exp_objects = []
        for s, runsuite in [(s1, runsuite1), (s2, runsuite2)]:
